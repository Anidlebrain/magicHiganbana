...
void pringtfEnd()
{
	...
	cout << "\tvar blockData = metal.registerPart(\"block\").getData();" << endl;
	cout << "\tblockData.addDataValue(\"hardness\", \"5\");" << endl;
	cout << "\tblockData.addDataValue(\"resistance\", \"30\");" << endl;
	cout << "\tblockData.addDataValue(\"harvestTool\", \"pickaxe\");" << endl;
	cout << "\tblockData.addDataValue(\"harvestLevel\", \"2\");" << endl;
	cout << "\t" << endl;
	cout << "\tvar oreData = metal.registerPart(\"ore\").getData();" << endl;
	cout << "\toreData.addDataValue(\"hardness\", \"5\");" << endl;
	cout << "\toreData.addDataValue(\"resistance\", \"30\");" << endl;
	cout << "\toreData.addDataValue(\"harvestTool\", \"pickaxe\");" << endl;
	cout << "\toreData.addDataValue(\"harvestLevel\", \"3\");" << endl;
	cout << "\t" << endl;
	cout << "\tvar denseOreData = metal.registerPart(\"dense_ore\").getData();" << endl;
	cout << "\tdenseOreData.addDataValue(\"hardness\", \"5\");" << endl;
	cout << "\tdenseOreData.addDataValue(\"resistance\", \"30\");" << endl;
	cout << "\tdenseOreData.addDataValue(\"harvestTool\", \"pickaxe\");" << endl;
	cout << "\tdenseOreData.addDataValue(\"harvestLevel\", \"3\");" << endl;
	cout << "\t" << endl;
...
int main()
{
	freopen("ingot.txt","r",stdin); 
	freopen("../ContentTweaker/ingot.zs","w",stdout); 
	//RGB
	//FILE *fp = fre
	...
	printfBegin();
	cout << "//材料注册" << endl;
	vector<string> veingot, vename, veid;;
